...
namespace WindowsFormsApp1
{
    public partial class CARGADEDOMICILIO : Form
    {
        ...
        private CargarComboBoxes provincias = new CargarComboBoxes();
        public Int64 _dnis;
        ...
        private void CARGADATOS_Click(object sender, EventArgs e)
            ...
            if (verificador.VerificarControles(this.Controls))
            {
                ...
                //   string consulta = "SELECT form3.Id, form3.CALLE, form3.NUMERO, form3.PISO, form3.DEPTO, localidades1.Provincia AS PROVINCIA, localidades1.municipio AS MUNICIPIO, localidades1.nombre AS NOMBRE, form3.TELCELCONTA AS CONTACTO, form3.EMAILOFICIAL AS EMAIL, form3.TELEMERGEN AS TEL FROM form3 INNER JOIN localidades1 ON(form3.LOCALIDAD = localidades1.idlocalidad) AND(form3.PARTIDO = localidades1.municipio_id)";
                ListView miListView = new ListView();
